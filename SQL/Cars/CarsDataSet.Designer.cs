...
namespace SQL.Cars {
    ...
    public partial class CarsDataSet : global::System.Data.DataSet {
        ...
        public partial class CarsDataTable : global::System.Data.TypedTableBase<CarsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CarsRow AddCarsRow(int BrandId, int ColorId, string ModelYear, decimal DailyPrice, string Description) {
...
namespace SQL.Cars.CarsDataSetTableAdapters {
    ...
    public partial class CarsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Cars] WHERE (([Id] = @Original_Id) AND ([BrandId] = @Original_" +
                "BrandId) AND ([ColorId] = @Original_ColorId) AND ([ModelYear] = @Original_ModelY" +
                "ear) AND ([DailyPrice] = @Original_DailyPrice) AND ([Description] = @Original_De" +
                "scription))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Cars] ([BrandId], [ColorId], [ModelYear], [DailyPrice], [Description]) VALUES (@BrandId, @ColorId, @ModelYear, @DailyPrice, @Description);
SELECT Id, BrandId, ColorId, ModelYear, DailyPrice, Description FROM Cars WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Cars] SET [BrandId] = @BrandId, [ColorId] = @ColorId, [ModelYear] = @ModelYear, [DailyPrice] = @DailyPrice, [Description] = @Description WHERE (([Id] = @Original_Id) AND ([BrandId] = @Original_BrandId) AND ([ColorId] = @Original_ColorId) AND ([ModelYear] = @Original_ModelYear) AND ([DailyPrice] = @Original_DailyPrice) AND ([Description] = @Original_Description));
SELECT Id, BrandId, ColorId, ModelYear, DailyPrice, Description FROM Cars WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SQL.Properties.Settings.Default.CarsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, BrandId, ColorId, ModelYear, DailyPrice, Description FROM dbo.Cars";
        ...
        public virtual int Delete(int Original_Id, int Original_BrandId, int Original_ColorId, string Original_ModelYear, decimal Original_DailyPrice, string Original_Description) {
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((decimal)(Original_DailyPrice));
        ...
        public virtual int Insert(int BrandId, int ColorId, string ModelYear, decimal DailyPrice, string Description) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((decimal)(DailyPrice));
            if ((Description == null)) {
        ...
        public virtual int Update(int BrandId, int ColorId, string ModelYear, decimal DailyPrice, string Description, int Original_Id, int Original_BrandId, int Original_ColorId, string Original_ModelYear, decimal Original_DailyPrice, string Original_Description, int Id) {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((decimal)(DailyPrice));
            if ((Description == null)) {
                throw new global::System.ArgumentNullException("Description");
            }
            else {
            ...
            if ((Original_ModelYear == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Original_ModelYear));
            }
            this.Adapter.UpdateCommand.Parameters[9].Value = ((decimal)(Original_DailyPrice));
            if ((Original_Description == null)) {
                throw new global::System.ArgumentNullException("Original_Description");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int BrandId, int ColorId, string ModelYear, decimal DailyPrice, string Description, int Original_Id, int Original_BrandId, int Original_ColorId, string Original_ModelYear, decimal Original_DailyPrice, string Original_Description) {
            return this.Update(BrandId, ColorId, ModelYear, DailyPrice, Description, Original_Id, Original_BrandId, Original_ColorId, Original_ModelYear, Original_DailyPrice, Original_Description, Original_Id);
        }
    }
